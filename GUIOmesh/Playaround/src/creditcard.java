	...
	private void initialize() {
		...
		btnAddCc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lrun.addCredit(a, b, c, d, supage.uname.getText(), snum.getText(), sname.getText(), apnum.getText(), city.getText(), state.getText(), zcode.getText());
			}
		});
		...
		btnViewMyCards.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cctarea.setText(lrun.listCCinfo(supage.uname.getText()));
			}
		});
