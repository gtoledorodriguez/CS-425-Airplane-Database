	...
	private void initialize() {
		...
		btnDone.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lrun.changecredit(StartApp.uname.getText(), g, h, i, j, modifycc.osnum.getText(), modifycc.osname.getText(), modifycc.oapnum.getText(), modifycc.ocity.getText(), modifycc.ostate.getText(), modifycc.ozcode.getText(), k, l, m, n, nsnum.getText(), nsname.getText(), napnum.getText(), ncity.getText(), nstate.getText(), nzip.getText());
